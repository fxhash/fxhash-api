...
@ObjectType({
  description:
    "The history of the market stats for **Generative Tokens**. Computed and updated periodically by a side-worker.",
})
export class MarketStatsHistory extends BaseEntity {
  @PrimaryGeneratedColumn()
  id: number

  @ManyToOne(() => GenerativeToken, token => token.marketStatsHistory, {
    onDelete: "CASCADE",
  })
  ...
  @Field(type => Number, {
    nullable: true,
    description: "The median of the collection at the end of the range covered",
  })
  @Column({ type: "bigint", nullable: true })
  median: number | null
  ...
  @Field(type => Number, {
    nullable: true,
    description: "The number of items listed at the end of the range covered",
  })
